...
if(isset($_POST['update_password'])) {
	...
	$old_password = strip_tags(mysqli_real_escape_string($con, ($_POST['old_password'])));
	$new_password_1 = strip_tags(mysqli_real_escape_string($con, ($_POST['new_password_1'])));
	$new_password_2 = strip_tags(mysqli_real_escape_string($con, ($_POST['new_password_2'])));
