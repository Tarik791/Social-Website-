...
class Message {
	...
	//this method is for send message 
	...
	public function getMessages($otherUser) {
		...
		//Whether the message is open or not
		...
		while($row = mysqli_fetch_array($get_messages_query)) {
			...
			$div_top = ($user_to == $userLoggedIn) ? "<div class='message' id='green' style='background-color:black;'>" : "<div class='message' id='blue'>";
			$data = $data . $div_top . $body . "</div><br><br>";
		}
		return $data;
	}

	//we are getting new message 
	...
	//we getting conversation in this method 
	public function getConvos() {
		...
		//display conversation, left mini border
	...
	//We have dropdown for messages in our menu 
	public function getConvosDropdown($data, $limit) {
		...
		foreach($convos as $username) {
			...
			//frontend for message in dropdown 
