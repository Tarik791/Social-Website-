<?php 
	...
	$names = explode(" ", $query); // if written "john smith" it's saved as johnsmith. explode puts whitespace between the tho words
	...
	else { // if in array there is one name or more than two
